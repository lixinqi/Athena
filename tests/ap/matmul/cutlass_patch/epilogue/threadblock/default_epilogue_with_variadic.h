...
template <typename Shape, typename WarpMmaSimt, typename ElementOutput,
          typename OutputOp, int ElementsPerAccess, bool ScatterD = false,
...
struct DefaultEpilogueWithVariadicSimt {
  ...
  using PackedOutputTileIterator =
      cutlass::epilogue::threadblock::PredicatedTileIterator<
          typename Base::OutputTileThreadMap, ElementOutput, ScatterD,
  ...
  using Epilogue = cutlass::epilogue::threadblock::EpilogueWithVariadic<
      Shape, WarpMmaSimt, Base::kPartitionsK, OutputTileIterator,
...
struct DefaultEpilogueWithVariadicSimtStridedDgrad {
  ...
  /// Use defaults related to the existing epilogue
  using Base = DefaultEpilogueSimtStridedDgrad<Shape, WarpMmaSimt, OutputOp,
                                               ElementsPerAccess>;
...
template <typename Shape, typename WarpMmaTensorOp, int PartitionsK,
          typename ElementOutput, typename OutputOp, int ElementsPerAccess,
...
struct DefaultEpilogueWithVariadicVoltaTensorOp {
  ...
  /// Use defaults related to the existing epilogue
  using Base = DefaultEpilogueVoltaTensorOp<Shape, WarpMmaTensorOp, PartitionsK,
                                            OutputOp, ElementsPerAccess>;
